...
# =============================================================================
# FREQUENCY DOMAIN DECOMPOSITION
class FDD_algo_MS(BaseAlgorithm[FDDRunParams, FDDResult]):
    RunParamCls = FDDRunParams
    ResultCls = FDDResult
    ...
    def run(self) -> FDDResult:
        ...
        freq, Sy = FDD_funct.SD_PreGER(Y, self.fs, nxseg, method=method)
        Sval, Svec = FDD_funct.SD_svalsvec(Sy)
...
# =============================================================================
# ENHANCED FREQUENCY DOMAIN DECOMPOSITION EFDD
class EFDD_algo_MS(FDD_algo[EFDDRunParams, EFDDResult]):
    method = "EFDD"
