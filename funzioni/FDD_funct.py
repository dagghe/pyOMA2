...
def FDD_MPE(Sy, freq, sel_freq, DF=0.1, ret_peak=False):
...
def EFDD_MPE(Sy, freq, dt, sel_freq, methodSy, method="FSDD", DF1=0.1, DF2=0.1, 
    ...
    nIFFT = (int(nxseg))*5
    Freq_FDD, Phi_FDD = FDD_MPE(Sy, freq, sel_freq, DF=DF1)
