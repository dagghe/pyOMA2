...
def test_geo1(ms_poser: MultiSetup_PoSER) -> None:
    ...
    ms_poser.def_geo1_byFILE(path="./src/pyoma2/test_data/3SL/Geo1.xlsx")
    ...
    # PLOTE_MODE_G1
    try:
        _ = ms_poser.plot_mode_g1(Algo_Res=algo_res, mode_nr=2)
...
def test_geo2(ms_poser: MultiSetup_PoSER) -> None:
    ...
    ms_poser.def_geo2_byFILE(path="./src/pyoma2/test_data/3SL/Geo2.xlsx")
    ...
    # PLOTE_MODE_G2
    try:
        _ = ms_poser.plot_mode_g2(Algo_Res=algoRes, mode_nr=1, scaleF=3, notebook=True)
