...
def test_geo1(ms_preger: MultiSetup_PreGER) -> None:
    ...
    ms_preger.def_geo1_byFILE(path="./src/pyoma2/test_data/3SL/Geo1.xlsx")
...
def test_geo2(ms_preger: MultiSetup_PreGER) -> None:
    ...
    ms_preger.def_geo2_byFILE(path="./src/pyoma2/test_data/3SL/Geo2.xlsx")
...
def test_run(ms_preger: MultiSetup_PreGER) -> None:
    ...
    """
    # Define geometry1
    ms_preger.def_geo1_byFILE(path="./src/pyoma2/test_data/3SL/Geo1.xlsx")  # BG lines
